...
let addAddressFormBtn = document.getElementById("add-address-form-btn");
let addAddressForm = document.getElementById("add-address-form");

// SHOWING THE ADD NEW ADDRESS FORM
function showNewAddressForm() {
  addAddressForm.classList.add("activate-add-new-address-form");
}

// HIDE THE NEW ADD ADDRESS FORM
function hideNewAddressForm() {
  addAddressForm.classList.remove("activate-add-new-address-form");
}
